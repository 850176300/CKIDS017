...
CCImage* CCImageColorSpace::imageWithHSB(CCImage *pRGBImage, int pHueValue, int pSaturationValue, int pBrightnessValue) {
    ...
    lImage->initWithImageData(lData, lLen, CCImage::kFmtRawData, pRGBImage->getWidth(), pRGBImage->getHeight());
    lImage->autorelease();
	return lImage;
}