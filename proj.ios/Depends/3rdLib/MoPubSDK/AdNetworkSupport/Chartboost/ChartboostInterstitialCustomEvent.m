...
#define kChartboostAppID @"5190819f17ba47ee7d000007"
#define kChartboostAppSignature @"81b863c69b029c01720603ad76c94931bf568a2c"
...
forChartboostInterstitialCustomEvent:(ChartboostInterstitialCustomEvent *)event
{
    if ([self.activeLocations containsObject:location]) {
        ...
        [event didFailToLoadInterstitial:location withError:0];
        return;
    }
...
{
    _hasCached = NO;
    [[self eventForLocation:location] didFailToLoadInterstitial:location withError:error];
